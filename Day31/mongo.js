...
// find products which product price value are same using aggregate and delete the duplicate
...
// DELETING THE FOUND ITEMS

db.products.deleteMany({product_price: {$in: [36.00, 47.00]}})