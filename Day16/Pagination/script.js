...
const numItems = document.getElementById('page-select');
var itemsPerPage = numItems.options[numItems.selectedIndex].value;
...
const first_button = document.getElementById('first');
...
last_button.addEventListener('click', function() {
    document.getElementsByClassName('page-button')[Math.ceil(data.length/itemsPerPage)-1].click();
})

next_button.addEventListener('click', function(){
    var active_page = document.getElementsByClassName('btn-primary')[0].innerText;
    if (active_page < Math.ceil(data.length/itemsPerPage)) {
        document.getElementsByClassName('page-button')[active_page].click();
    }
})
...
prev_button.addEventListener('click', function(){
    var active_page = document.getElementsByClassName('btn-primary')[0].innerText;
    if (active_page > 1) {
        document.getElementsByClassName('page-button')[active_page-2].click();
    }
})
